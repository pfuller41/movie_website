...
class Movie (): #class allows us to make classes, like a blueprint, it can have data and methods
	...
	def __init__(self, movie_title, movie_storyline, poster_image, trailer_youtube, year): #init is a constructor, calls all the data, self is keyword(instance in question toy_story etc.)
